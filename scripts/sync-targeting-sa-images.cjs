#!/usr/bin/env node
/**
 * Скачивает в img/ отсутствующие storage__* из /_sa/img/ в targeting/index.html (legacy /storage/ на prod).
 */
const fs = require("fs");
...
const htmlPath = path.join(root, "targeting", "index.html");
...
(async () => {
  ...
  console.log(`sync-targeting-sa-images: ${n} new file(s), ${names.size} referenced`);
})();
