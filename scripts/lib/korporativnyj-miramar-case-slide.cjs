...
const MIRAMAR_CASE_IMG =
  "/_sa/img/services/korporativnyj_sajt/miramar-case-slide.webp?v=20260604k1920";

/** Тёмная колонка макета слева — уводим бассейн/белое справа от зоны текста. */
const MIRAMAR_BG_STYLE =
  "background-image: url(&quot;MIRAMAR_IMG&quot;); background-position: 4% 48%; background-size: 175% auto;";
...
function patchKorporativnyjSecondCasesSlideMiramar(html) {
  return patchN4fvkCasesBlock(html, (chunk) =>
    replaceN4fvkSlideAt(chunk, 1, buildMiramarSecondSlideHtml),
  );
}
