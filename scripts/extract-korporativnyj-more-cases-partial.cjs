#!/usr/bin/env node
/**
 * more-cases-korporativnyj-sajt.html из tmp/korporativnyj-prod-full.html
 */
const fs = require("fs");
...
const outPath = path.join(root, "html", "partials", "services", "more-cases-korporativnyj-sajt.html");
