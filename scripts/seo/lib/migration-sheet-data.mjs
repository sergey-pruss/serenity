...
/** Порядок строк в таблице Google Sheets (по приоритету работ). */
export const MIGRATION_PAGES = [
  ...
  },
  {
    ...
    staticDate: "",
    tz: "Готово",
    tzUrl: `${STATIC_DOCS}/smm-marketing-onepage-seo-tz.html`,
    impl: "",
    comment: "Готовим перенос в новый контур (пока legacy)",
  },
  {
  ...
  },
  {
    ...
    tzUrl: "",
    impl: "Очередь",
    comment: "Topvisor 24.05: кластер ~60+ запросов, вне топ-10",
  },
  {
