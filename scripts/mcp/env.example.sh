...
# Google Search Console MCP (достаточно одного варианта):
# npm run mcp:gsc-sync-oauth  → secrets/mcp/gsc-oauth-desktop.json (путь из sergey-pruss.github.io/.cursor/mcp.json)
