#!/usr/bin/env node
/**
 * Генерирует html/partials/services/awards-targeting.html
...
const outPath = path.join(root, "html", "partials", "services", "awards-targeting.html");
      ...
      <section class="wrapper home-awards-section">
        <div class="awards">
          <div class="awards__header">
            <h3 class="home-clients-awards__title kontekstnaya-page__section-heading" data-v-08586076="" id="targeting-awards-heading">Награды</h3>
          </div>
          <div
