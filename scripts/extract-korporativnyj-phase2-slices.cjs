#!/usr/bin/env node
/**
 * Вырезает из tmp/korporativnyj-prod-full.html секции для phase2 partials.
 */
const fs = require("fs");
...
const middleOut = path.join(root, "html", "partials", "services", "korporativnyj-phase2-middle.html");
const clientsOut = path.join(root, "html", "partials", "services", "korporativnyj-phase2-clients.html");
