...
function buildMain() {
  ...
  const contentBlocks = readPartial("prodvizhenie-yandex-karty-2gis-content-blocks.html");
  ...
  return [
    ...
    factsCard,
    contentBlocks,
    "<!-- YMAPS-CONTENT-BLOCKS-REMAINING: виды, эффективность, отчётность -->",
    "<!-- YMAPS-CASES-SLIDER -->",
    "<!-- YMAPS-PRICING-TABLES -->",
    "<!-- YMAPS-INLINE-LEAD -->",
    "<!-- YMAPS-TEAM -->",
    "<!-- YMAPS-FAQ -->",
    "<!-- YMAPS-BLOG -->",
...
function main() {
  ...
  html = html.replace(/kompleksnoye-prodvizheniye-static-stack\.css\?v=[^"]+/, `${a.cssStack}?v=20260608ymapsContent`);
