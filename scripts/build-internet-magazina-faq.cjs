...
const items = [
  ...
  [
    ...
    spoiler(
      ...
      "В&nbsp;стандартный пакет входит месяц сопровождения: правим ошибки, помогаем команде освоить админку, дорабатываем мелочи. После&nbsp;— предлагаем <a href=\"/tehnicheskaya-podderzhka-saita\" class=\"internet-magazina-text-link\">техническую поддержку сайта</a> по&nbsp;абонентскому сопровождению или&nbsp;работу по&nbsp;часам. Формат подбираем под&nbsp;нагрузку и&nbsp;пожелания клиента.",
    ),
  ],
];
