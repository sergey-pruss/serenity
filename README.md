# Serenity — статическое зеркало (`serenity_lanidng`)

Раньше главная собиралась вручную и расходилась с оригиналом. **Сейчас источник правды — снимок страницы с продакшена** (или с вашего локального Nuxt): тот же HTML после гидрации, те же `<script>` / `<link>`, визуально как на `serenity.agency`.
