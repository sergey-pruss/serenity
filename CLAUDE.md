...
- Проверить руками на трех доменах (`serenity.agency`, `static.serenity.agency`, `serenity.sergeyprus.workers.dev`):
  - hero-видео: нет долгой заставки/белого кадра до старта;
  - слайдеры: стрелки видимы на desktop/tablet-ширинах согласно текущему брейкпоинту;
  - меню/оверлей: дефолтный город — `Москва`.
